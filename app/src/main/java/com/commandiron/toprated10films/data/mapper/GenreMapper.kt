...
fun MovieDbGenre.toGenre(): Genre {
    return Genre(
        ...
        imageUrl = when(name) {
            ...
            "Adventure" -> "https://netstorage-tuko.akamaized.net/images/62986d234ef17429.jpg"
            "Animation" -> "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/bam-incredibles-resize-1537212803.jpg"
            ...
            "Horror" -> "https://i1.wp.com/filmloverss.com/wp-content/uploads/2020/06/the-shining-3-filmloverss.jpg"
            ...
            "Western" -> "https://www.hollywoodreporter.com/wp-content/uploads/2013/02/django_1.jpg"
